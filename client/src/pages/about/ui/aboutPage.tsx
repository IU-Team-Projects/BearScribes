    ...
    return (
        <div data-testid="about">
            ...
            <div className={styles.text_description}>
                {' '}
                Bearscribes is a Project for searching, saving and <br />{' '}
                exchanging books between its participants.
            </div>
            <button onClick={() => router.push('/')} className={styles.return}>
                {' '}
                return{' '}
            </button>
            <div className={styles.participants}>
                {' '}
                Project was created <br /> by 5 enthusiasts{' '}
                <ul>
            ...
            <div className={styles.final}>
                {' '}
                Want to know more? Visit our resources!
            </div>
            ...
            <div className={styles.image1}>
                <Image src="/proverb.png" alt={'Image'} layout="fill" />
            </div>
            <div className={styles.image2}>
                <Image src="/book.png" alt={'Book'} layout="fill" />
            </div>
        </div>
    );
}
